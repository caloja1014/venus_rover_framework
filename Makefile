DEPS = common.h queue.h opprocesor.h op_code_buffer.h map.h threadpool.h
CFLAGS= -Wall -c -g
...
framework: framework.o common.o queue.o op_code_buffer.o opprocesor.o map.o threadpool.o  $(DEPS)
	gcc -o $@ framework.o common.o queue.o op_code_buffer.o opprocesor.o map.o threadpool.o  -L. -lpthread $(DFLAGS)
